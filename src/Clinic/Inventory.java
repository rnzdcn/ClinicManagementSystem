...
=======
        ...
        Isearch.setBorder(BorderFactory.createCompoundBorder(
                Isearch.getBorder(), BorderFactory.createEmptyBorder(0, 15, 0, 0)));
    ...
    public void updateTable() {
        try {
            String sql = "select id as 'MEDICINE ID', medicinename as 'MEDICINE NAME', quantity as 'QUANTITY', daterecieved as 'RECEIVED DATE', expirationdate as 'EXPIRATION DATE', "
                    + "description as 'DESCRIPTION', status as 'STATUS' from clinicmanagement.inventory";
>>>>>>> Stashed changes
...
=======
        ...
        Itable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        Itable.setRowHeight(32);
...
=======
    ...
    private void jButton2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseEntered
        ...
        jButton2.setForeground(new Color(10, 46, 54));
        onClick(jButton2);
